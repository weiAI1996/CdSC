...
def main():        
    net = Net(3, label_nbr=RS.num_classes).cuda()
    ...
    optimizer = optim.Adam(filter(lambda p: p.requires_grad, net.parameters()), lr=args['lr'], betas=(0.9, 0.999),weight_decay=0.01, )

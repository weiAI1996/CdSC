...
class PredOptions():
    ...
    def initialize(self, parser):
        ...
        parser.add_argument('--test_dir', required=False, default='/data2/jw/semantic_cd/datasets/JL1_second/test/', help='directory to test images')
        parser.add_argument('--pred_dir', required=False, default='./PRED_CDSC', help='directory to output masks')
        parser.add_argument('--chkpt_path', required=False, default='/data2/jw/semantic_cd/Bi-SRNet-main/checkpoints/JL1_84027/cdsc_sca_94e_mIoU85.10_Sek55.89_Fscd86.98_OA93.05.pth')
